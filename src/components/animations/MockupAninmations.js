...
const Wrapper = styled.div`
  ...
  * {
  ...
  .mockup1 {
    ...
    box-shadow: 0px 16.3824px 32.7761px rgba(99, 30, 187, 0.5),
  ...
  .mockup2 {
    ...
    box-shadow: 0px 8.19119px 16.3824px rgba(0, 0, 0, 0.1),
      0px 16.3824px 32.764px rgba(0, 0, 0, 0.15),
      inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
  ...
  .mockup4 {
    ...
    background: url("/images/animations/mockup4.svg"), rgba(39, 20, 62, 0.2);
    box-shadow: inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(20px);
    /* Note: backdrop-filter has minimal browser support */
